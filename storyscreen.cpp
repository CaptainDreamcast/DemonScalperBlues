...
static void loadImageGroup() {
	...
	gStoryScreenData.currentTextPos = getMugenDefVector2DOrDefaultAsGroup(gStoryScreenData.mCurrentGroup, "text.pos", Vector2D(67, 175));
...
static void loadTextGroup() {
	...
	if (!strcmp(gStoryScreenData.mDefinitionPath, "game/OUTRO.def") &&  gStoryScreenData.mNextVoice == 3)
	{
	...
	setMugenTextTextBoxWidth(gStoryScreenData.mTextID, 200);
